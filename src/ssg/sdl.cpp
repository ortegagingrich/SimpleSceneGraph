...
int ssg::create_SDL_window(SDL_Window **win, const char *window_name, int sx, int sy){
	/**
...
void ssg::remove_SDL_window(SDL_Window *window){
	/**
...
SDL_Renderer *ssg::create_SDL_renderer(SDL_Window *window, int hardware_accelerated){
	/**
