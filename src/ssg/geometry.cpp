...
bool ssg::calculate_intersection(Line2f l1, Line2f l2){
	/**
...
bool ssg::calculate_intersection(Line2f l1, Line2f l2, Vector2f &out){
	/**
	 * Checks to see if the two line segments intersect at a SINGLE point.  If
...
bool ssg::calculate_intersection(Rect2f rect, Vector2f point){
	float x = point.x;
	float y = point.y;
	return x >= rect.xMin && x <= rect.xMax && y >= rect.yMin && y <= rect.yMax;
}

bool ssg::calculate_intersection(Rect2f rect, Line2f line){
	Line2f dummy;
	return calculate_intersection(rect, line, dummy);
}

bool ssg::calculate_intersection(Rect2f rect, Line2f line, Line2f &out){
...
bool ssg::calculate_intersection(Rect2f r1, Rect2f r2){
	Rect2f dummy;
	return calculate_intersection(r1, r2, dummy);
}

bool ssg::calculate_intersection(Rect2f r1, Rect2f r2, Rect2f &out){
